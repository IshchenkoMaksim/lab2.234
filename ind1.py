...
(например, задачи из области физики, экономики, математики, статистики и т. д.)
с помощью паттерна “Производитель-Потребитель”, условие которой предварительно
...
if __name__ == '__main__':
    ...
    str_2 = Shooter(0.7, "Сергей ")
    str_3 = Shooter(0.6, "Дима ")
    str_4 = Shooter(0.9, "Павел ")
    str_5 = Shooter(0.4, "Миша ")
    shoot = [str_1, str_2, str_3, str_4, str_5]
